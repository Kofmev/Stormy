...
public class DailyListItemBindingImpl extends DailyListItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.degreeSmallView, 5);
    }
    // views
    // variables
    // values
    ...
    protected void executeBindings() {
        ...
        long mathRoundDayTemperature = 0L;
        java.lang.String stringValueOfMathRoundDayTemperature = null;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                // read Math.round(day.temperature)
                mathRoundDayTemperature = java.lang.Math.round(dayTemperature);
                // read String.valueOf(day.time)
                stringValueOfDayTime = java.lang.String.valueOf(dayTime);


                // read String.valueOf(Math.round(day.temperature))
                stringValueOfMathRoundDayTemperature = java.lang.String.valueOf(mathRoundDayTemperature);
        }
        // batch finished
        if ((dirtyFlags & 0x3L) != 0) {
            // api target 1
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.temperatureLabel, stringValueOfMathRoundDayTemperature);
        }
    }
